    ...
    return (
        <div className="container mx-auto px-10 py-5 flex flex-col gap-10">
            <div>
                {
                    !cart.length ? (
                        <h2 className="font-bold flex flex-col items-center gap-5 text-2xl text-center">
                            ...
                            <button className="border px-2 py-1 rounded-2xl cursor-pointer active:scale-75"><NavLink to={"/products"}>Go to shoping</NavLink></button>
                        </h2>
                    ) : cart.length == 1 ? (
            ...
            <div className="flex flex-col gap-5">
                {cart.map((i) => {
                    return (
                        <div className="border-l-4 border-amber-400 flex justify-between item-center p-5 rounded-2xl">
                            <div className="flex items-center gap-5">
                                <img src={i.image} alt={i.image} width={100} />
